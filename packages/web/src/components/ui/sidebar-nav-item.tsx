...
export function SidebarNavItem({ href, label, active, onClick }: SidebarNavItemProps) {
  const className = cn(
  ...
  return <button type="button" onClick={onClick} className={cn(className, "w-full text-left")}>{label}</button>;
}
